    ...
    return [
      ...
      section('sparkles', 'AI model', [
        el('p', { class: 'muted small' },
          provider === 'openrouter'
            ...
            : provider === 'openai'
              ? 'Running on the OpenAI fallback. Add OPENROUTER_API_KEY to .env to unlock model selection.'
              : 'Offline - add OPENROUTER_API_KEY to .env to enable generation and model selection.'),
        modelRow(),
      ]),
      ...
      section('help', 'About', [
        ...
        provider === 'offline' ? el('div', { class: 'notice' }, icon('zap', 16),
          el('span', {}, 'To unlock generation: create a key at openrouter.ai, then add OPENROUTER_API_KEY="sk-or-…" to the .env file in the repo root and restart the app.')) : null,
